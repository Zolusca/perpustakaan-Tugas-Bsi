...
<head>
    ...
    <link rel="stylesheet" href="/css/adminlistuserpinjam.css">
    <title></title>
</head>
<body>
    ...
    <div class="core">
        ...
        <div class="konten">
            <div class="pencarianuser">
                <form action="<?= base_url().'admin/dashboard/caripeminjam'?>" class="form-email" method="post">
                    <span>Pencarian User Pinjam</span>
                    <table>
                        <tbody>
                        <tr>
                            <td>Email User </td>
            ...
            <div class="datauserbooking">
                ...
                <form action="<?= base_url()."admin/dashboard/userambilbuku"?>" method="post">
                    <table>
                        ...
                        <?php if (isset($datauserpinjam)) :?>
                        <?php $dataUser = $datauserpinjam['user']?>
                            <!--     index disni adalah nilai index dari array dari 0 sampai habis       -->
                            <?php foreach ($datauserpinjam['datapinjaman'] as $index=>$value):?>
